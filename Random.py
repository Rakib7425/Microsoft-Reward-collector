...
random_page_generator = [
    ...
    # " N o n a g o n a l ", " S e l f ", " P o s i t i v e "
    

    # 2
    # "T h e","s u n","i s","s h i n i n g","a n d","i t","i s","a","b e a u t i f u l","d a y","o u t s i d e",".","I","h o p e","y o u","a r e","d o i n g","w e l l","a n d","e n j o y i n g","t h e","d a y",".","D o","y o u","n e e d","a n y","h e l p","t o d a y","?","I","a m","h e r e","t o","a s s i s t","y o u","i n","a n y","w a y","I","c a n", "T h e"
    ...
    # " H a r d w o r k "," S u c c e s s "," V e r s a t i l i t y "," F l e x i b i l i t y "," H u m i l i t y "
]
